...
%    not done already.
    ...
    elseif strcmp( getenv('USER'), 'maxc')        
    ...
    elseif strcmp( getenv('USER'), 'macx') 
        IHOGDIR      = '~/Documents/MATLAB/lib/ihog-master/';        
        VLFEATDIR    = '~/Documents/MATLAB/lib/vlfeat/toolbox/';
        TSNEDIR      = '~/Documents/MATLAB/lib/tSNE_matlab/';
